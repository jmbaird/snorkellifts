...
/* __string_template__622eb27186cb17c91581f099ba1b68dd */
class __TwigTemplate_a064f8cd3a0925a965d56f0c766149e4 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t<p>Submitted by: ";
        // line 15
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->extensions['Drupal\webform\Twig\WebformTwigExtension']->webformToken("[webform_submission:user]", $this->sandbox->ensureToStringAllowed(($context["webform_submission"] ?? null), 15, $this->source)), "html", null, true);
        echo "</p>
\t\t\t\t\t\t<p>";
        // line 16
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->extensions['Drupal\webform\Twig\WebformTwigExtension']->webformToken("[webform_submission:values:webform_token_options_html:webform_token_options_email]", $this->sandbox->ensureToStringAllowed(($context["webform_submission"] ?? null), 16, $this->source)), "html", null, true);
        echo "</p>
\t\t\t\t\t</td>
\t\t\t\t</tr>
\t\t\t\t<tr>
\t\t\t\t\t<td style=\"color:#000000; font-family:'Open Sans', sans-serif; font-size:14px; font-weight:400; line-height:21px;\">Helpful administrative links:</td>
\t\t\t\t</tr>
\t\t\t\t<tr>
\t\t\t\t\t<td><a href='/admin/structure/webform/manage/warranty_claim_form_usa/results/download' target='_blank'>Download results as Excel/PDF (in batches)</a></td>
\t\t\t\t</tr>
\t\t\t\t<tr>
\t\t\t\t\t<td><a href=\"/print/pdf/webform_submission/";
        // line 26
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(($context["sid"] ?? null), 26, $this->source), "html", null, true);
        echo "?view_mode=table\" target='_blank'>Download this submission as a PDF</a></td>
\t\t\t\t</tr>
\t\t\t\t<tr>
\t\t\t\t\t<td><a href=\"/admin/structure/webform/manage/warranty_claim_form_usa/submission/";
        // line 29
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(($context["sid"] ?? null), 29, $this->source), "html", null, true);
        echo "\" target='_blank'>View/edit this submission online</a></td>
\t\t\t\t</tr>
\t\t\t</table>
\t\t</td>
\t</tr>
...
\t</tr>
    ...
    {
        return "__string_template__622eb27186cb17c91581f099ba1b68dd";
    }
    ...
    {
        return array (  84 => 29,  78 => 26,  65 => 16,  61 => 15,  57 => 14,  44 => 4,  39 => 1,);
    }

    public function getSourceContext()
    {
        return new Source("", "__string_template__622eb27186cb17c91581f099ba1b68dd", "");
    }
