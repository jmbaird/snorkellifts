...
/* __string_template__0877e66799991a75ab08041abd67c748 */
class __TwigTemplate_4e57a6cf2d0c45408d8ea38a0dcd59db extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t<p>Thank you for submitting your online warranty claim to Snorkel&trade;. A copy of your submission is attached below in this e-mail for your records.</p>

\t\t\t<p>Our warranty team will review your claim and will contact you soon.</p>

\t\t\t<p>If you have any questions relating to this claim, please contact <a href=\"mailto:warranty.usa@snorkellifts.com\" style=\"color:#f68933;\">warranty.usa@snorkellifts.com</a>, quoting warranty claim number <b>";
        // line 10
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->extensions['Drupal\webform\Twig\WebformTwigExtension']->webformToken("[webform_submission:values:reference_number:value:webform_token_options_html:webform_token_options_email]", $this->sandbox->ensureToStringAllowed(($context["webform_submission"] ?? null), 10, $this->source)), "html", null, true);
        echo "</b>.
...
\t</tr>
    ...
    {
        return "__string_template__0877e66799991a75ab08041abd67c748";
    }
    ...
    {
        return array (  67 => 21,  63 => 20,  50 => 10,  39 => 1,);
    }

    public function getSourceContext()
    {
        return new Source("", "__string_template__0877e66799991a75ab08041abd67c748", "");
    }
    ...
    public function checkSecurity()
    {
        ...
        static $functions = array("webform_token" => 10);
