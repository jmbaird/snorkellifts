...
Tags: export, migrate, wordpress csv export, migration, woocommerce, order export
...
Version: 2.4.4
Author: smackcoders
Plugin URI: https://wordpress.org/plugins/wp-ultimate-exporter
...
The WordPress Ultimate Exporter plugin is a powerful tool that allows you to export all of your WordPress content, including posts, pages, custom fields, users, and more, to a CSV or XML file. This can be useful for backing up your data, migrating to another WordPress site, or simply for having a copy of your content in a different format.

Why export your WordPress content?

There are many reasons why you might want to export your WordPress content, including:

* To back up your data in case something happens to your site.
* To migrate your site to a new server or hosting provider.
* To move your site to a different domain.
* To create a copy of your site for testing or development purposes.
* To share your content with others for collaborations.

Exporting WordPress content has never been easier with the WP Ultimate Exporter plugin!

This plugin gives you several options to export all of your content or specific types of content. It also includes advanced filters to exclude unwanted and unused items, so you can trim your content to just the essentials.

The WP Ultimate Exporter plugin is an add-on to the WP Ultimate CSV Importer plugin, so you'll need to have both installed and activated before you can use it.

Once activated, the WP Ultimate Exporter plugin will add a new "Export" tab to the WP Ultimate CSV Importer menu.

To export your WordPress content, simply follow these steps:
* Go to WP Ultimate CSV Importer > Export.
* Select the type of content you want to export.
* Configure the export options, such as the file name, file format, and filters.
* Click Export to download the exported file.

The WP Ultimate Exporter plugin supports exporting the following WordPress elements:
* Posts
* Pages
* Custom Posts
* Post Tags
...
The plugin supports to export of file formats like CSV or XML. The advanced filter options will ease up the whole process. It helps to export only the data required without many complications. Also, filters for author, delimiters, status, and time range are available.

**Imp. Note: This plugin is an add-on. Therefore, before proceeding with the export, please install the [WP Ultimate CSV Importer](https://wordpress.org/plugins/wp-ultimate-csv-importer/) plugin first.**
...
* Filter post data by author's name
...
* SEO fields: All-in-One SEO and Yoast SEO
...
**Exporting Content:**
   - Export multilingual content (Posts, Pages, Custom Posts, etc.).
   - Select the desired post type or module.
   - Choose file type (CSV, XML, XLS, JSON).
   - Option to schedule exports.

= Try it in action =
You can explore the functionality of the plugin through our demo sites:

* [Free plugin demo site](https://demo.smackcoders.com/ultimatecsvimporter/wp-admin/admin.php?page=com.smackcoders.csvimporternew.menu&utm_source=WpOrg&utm_medium=Readme&utm_campaign=free_exporter).
* [Pro plugin demo site](https://demo.smackcoders.com/wordpress/wp-admin).
...
* Go to the Export tab in the plugin.
* Choose one module.
* Click on 'Continue' to move next to export.

**Step 2: Advanced Settings & Filters**
* Provide the filename and file type.
* To export the data based on filters, select any desired export filters and specify the values.
* Click 'Export' and download the exported file in the configured file format.
...
3. Please refer to the section above titled "How to Export" for further instructions.

If you have any other questions, check our documentation or contact our support. 

== Export WooCommerce ==
If you have a WooCommerce store that is operational, navigate to the export tab of the plugin and select one of the available options. Once you've made your selections name your file, choose the file format, and apply the advanced option to the Export.

* WooCommerce Products: You can Export all WooCommerce products along with their images, containing all of the products and product data that you selected as a CSV or any supported file. 
* WooCommerce Variations: Do you have WooCommerce product variations? just like products you can get variations that can be exported, manipulated, and imported back if needed.
* WooCommerce Orders: Exporting orders with status can help you prepare periodic reports, analyses, and studies.
* WooCommerce Refunds: Export refunds to calculate the percentage along with your sales and marketing reports. 
* WooCommerce Coupons: The export can help you find the effectiveness of coupon offers and plan your future promotions.

This is useful if you need to export your products, variations, orders, and refunds to a spreadsheet for further analysis or manipulation to import back. This file can be imported into another WooCommerce installation or store setup.
...
Click 'Export' to load the plugin's export screen where you can select what you want to export i.e. menus here. Select "Custom Posts" >> choose "nav_menu_item" from the list of options from the dropdown you want to export and then click on the Continue button. Name the file to process, hit export, and download the file to your computer.
...
Watch this informative video tutorial on the WP Ultimate Exporter plugin including various third-party plugins for data export.
[youtube https://www.youtube.com/watch?v=vEt4MNzPIvY&list=PL2k3Ck1bFtbR9UJfZQNT2KHa44YdbVOnF&index=1&utm_source=WpOrg&utm_medium=Readme&utm_campaign=free_exporter]
...
* WooCommerce * Products with categories, attributes, tags, and Images exported. Orders, Refunds, Variations, and Coupons can be exported.
...
= 2.4.3 =
* Upgrade now for Polylang Export, bug fixes, and improvements

= 2.4.2 =
* Upgrade now to get a security patch.

= 2.4.1 =
* Upgrade now to get a security patch.

= 2.4 =
* Upgrade now to get Elementor support

= 2.3 =
* Upgrade now for WordPress 6.4.1 Compatibility 
...
= 2.1 =
* Upgrade now to get LifterLMS and MasterStudy LMS Support.

= 2.0.1 =
* Upgrade now to get the latest updates

= 2.0 =
* Must upgrade now for WooCommerce Orders, Coupons, and Refunds Export. And XLS, XML, and JSON export file formats with improved UX and bug fixes
