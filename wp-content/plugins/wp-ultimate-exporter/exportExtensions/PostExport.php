...
class PostExport extends ExportExtension{
	...
	public function getRecordsBasedOnPostTypes ($module, $optionalType, $conditions ,$offset , $limit ,$headers = '') {
		...
		elseif ($module == 'WooCommerceVariations') {
			...
			return array_reverse($variation_ids);		
		}
		...
		// 	$product_statuses = array('publish', 'draft', 'future', 'private', 'pending');
		// 	$products = wc_get_products(array('status' => $product_statuses, 'numberposts' => -1));
		// 	$ids = array();
	...
	public function getPostsMetaDataBasedOnRecordId ($id, $module, $optionalType) {
		...
		$this->getCustomFieldValue($id, $value, $checkRep, $allacf, $typeOftypesField, $alltype, $jet_fields=null, $jet_types=null, $jet_rep_fields =null, $jet_rep_types=null,  $parent, $typesf, $group_unset , $optionalType , self::$export_instance->allpodsfields, $metabox_fields, $module, $metabox_relation_fields =null);			
