...
class SmackCSV{
	...
	public function __construct() { 
		...
		// if (!self::is_upgrade_notice_dismissed()) {
	...
	public static function upgrade_notice() {
		...
		<p>  Upgrade to PRO with code <b>WPCSVFREE2PRO</b> for advanced features! Unlock bulk imports, lifetime support, enhanced mapping, scheduled updates, and exclusive features! Don't miss out  <a href="https://www.smackcoders.com/wp-ultimate-csv-importer-pro.html?utm_source=csv-importer-free-admin-notice&utm_medium=wp_org_readme&utm_campaign=csv-pro-coupon" class="button button-pro promo-btn" target="_blank">upgrade now</a>
        </p>
	...
	public static function dismiss_upgrade_notice() {
		update_option('csv_upgrade_notice_dismissed', true);
